# Extracted text: coauthor-dossier-ambitious.docx

Source path: /Users/ra1/QuantumAccounting/BookChapter/review/docx/coauthor-dossier-ambitious.docx
...
Confirm that the description of Fellingham, Lin, and Schroeder (2022) does not overstate the decision/accounting/information equivalence.

Confirm the Demski, Fellingham, Lin, and Schroeder (2008) performance-measurement summary before relying heavily on the agency implications.

Decide whether the terms "superposition property" and "entanglement property" should remain as named accounting properties or be softened throughout to "superposition analogue" and "entanglement analogue."

Confirm the n-account wording in the chapter and supplement: one-account/two-bit capacity is separate from the broader n-bit extension.

Decide whether the main chapter should keep all formal callouts or move some of them entirely into the supplement.
...
Reduce the worked channel-capacity example table but keep the prose explanation.

Move one or two formal callouts entirely into the supplement.

Shorten the performance-measurement analogy.

Preserve the thesis, amplitude caveat, channel-capacity conditions, and odd-cycle numerical comparison.
